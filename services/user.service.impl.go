...
//Service Implication Methods -> Methods to interact with DB
...
func (u *UserServiceImpl) GetUser(name *string) (*models.User,error){
	...
	query := bson.D{bson.E{Key:"user_name",Value:name}}//this bson query is used for searching object with same conditions in DB
